...
//    }
    ...
    DISCOVERY_RDM_Data.value[16] = 0xAA;
    PDCount = 0;
    checkSum = 0;
    while (PDCount < 6) { //value[15~5]]=Encode UID
        DISCOVERY_RDM_Data.value[15 - PDCount * 2] = UID[PDCount] | 0xAA;
        DISCOVERY_RDM_Data.value[14 - PDCount * 2] = UID[PDCount] | 0x55;
        checkSum += DISCOVERY_RDM_Data.value[15 - PDCount * 2];
        checkSum += DISCOVERY_RDM_Data.value[14 - PDCount * 2];
        PDCount++;
    }
    TX_RDM_Data.CS = checkSum;
    PDCount = 0; //value[4~1]=CheckSum of EUID
    DISCOVERY_RDM_Data.value[3] = TX_RDM_Data.CSH | 0xAA;
    DISCOVERY_RDM_Data.value[2] = TX_RDM_Data.CSH | 0x55;
    DISCOVERY_RDM_Data.value[1] = TX_RDM_Data.CSL | 0xAA;
    DISCOVERY_RDM_Data.value[0] = TX_RDM_Data.CSL | 0x55;
